            ...
            <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div>
                    ...
                    <p className="text-sm text-yellow-100/80 leading-relaxed">
                        MovieStream is your personalized gateway to cinematic adventures. Curated picks, trending trailers, and unique vibes – just
                        for you.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm">
                        ...
                        <li>
                            <Link to="/trending" className="hover:text-yellow-300 transition-colors">
                                Trending
                            </Link>
                        </li>
                        <li>
                            <Link to="/saved" className="hover:text-yellow-300 transition-colors">
                                Saved Movies
                            </Link>
                        </li>
                        <li>
                ...
                <div>
                    ...
                    <ul className="flex gap-4 items-center">
                        ...
                        <li>
                            <a href="mailto:info@moviestream.com" className="hover:text-yellow-300">
                                <Mail className="w-5 h-5" />
                            </a>
                        </li>
                    </ul>
                    <p className="text-sm text-yellow-100/70 mt-4">
                        Made with <Heart className="inline w-4 h-4 text-pink-400 mx-1" /> by movie lovers.
                    </p>
                </div>
            </div>

            <div className="text-center text-xs text-yellow-100/50 mt-10">© {new Date().getFullYear()} Cinemati. All rights reserved.</div>
        </footer>
    )
}
